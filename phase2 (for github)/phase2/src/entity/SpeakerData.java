...
public class SpeakerData extends UserData{
    ...
    private final List<Integer> speakingAt;
     ...
     * @return The String "Speaker"
     */
    @Override
    public String getUserType() { return "Speaker"; }

    /**
     * Remove the eventID of the Event this Speaker is speaking.
     * @param eventID The eventID of the Event
     * @return True iff the eventID has been removed; else returns false
     */
